...
class Product {
  ...
  factory Product.popularProductFromJson(Map<String, dynamic> data) => Product(
      id: data['id'] ?? 0,
      name: data['attributes']['product']['data']['attributes']['name'] as String? ?? '',
      description: data['attributes']['product']['data']['attributes']['description'] as String? ?? '',
      images: (data['attributes']['product']['data']['attributes']['images']['data'] as List<dynamic>?)
          ?.map((image) => image['attributes']['url'] as String? ?? '').toList() ?? [],
      tags: []
  );
